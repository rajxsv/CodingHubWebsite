            ...
            <div className="container mx-auto py-8">
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-400">
                        Coding Hub is an inclusive platform aimed at providing resources and tools for mastering various
                        programming languages, development practices, and problem-solving techniques.
                    </p>
                </section>
                <section className="bg-gray-900 text-white py-12 rounded-lg text-center mb-12">
                    ...
                    <Link to={"/signup"}>
                        <button
                            className="mt-6 px-8 py-3 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Sign Up Now !
                        </button>
                    </Link>
                </section>
